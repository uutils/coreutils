...
fn test_repeat_reference_newer_last() {
    ...
    at.touch(FILE1);
    at.touch(FILE2);
    set_file_times_unix(&at, FILE1, 981203696); // 2001-02-03 12:34:56
    set_file_times_unix(&at, FILE2, 1323779696); // 2011-12-13 12:34:56
...
fn test_repeat_reference_older_last() {
    ...
    at.touch(FILE1);
    at.touch(FILE2);
    set_file_times_unix(&at, FILE1, 1323779696); // 2011-12-13 12:34:56
    set_file_times_unix(&at, FILE2, 981203696); // 2001-02-03 12:34:56
    ucmd.args(&["-I", "-r", FILE1, "-r", FILE2])
        .succeeds()
        .stdout_only("2001-02-03\n")
        .no_stderr();
