...
fn test_prefix() {
    ...
    assert_eq!(result.stdout,
               get_file_contents("lists_prefix.expected"));
}
...
fn test_char_range() {
    ...
    assert_eq!(result.stdout,
               get_file_contents("lists_char_range.expected"));
}
...
fn test_column_to_end_of_line() {
    ...
    assert_eq!(result.stdout,
               get_file_contents("lists_column_to_end_of_line.expected"));
}
...
fn test_specific_field() {
    ...
    assert_eq!(result.stdout,
               get_file_contents("lists_specific_field.expected"));
}
...
fn test_multiple_fields() {
    ...
    assert_eq!(result.stdout,
               get_file_contents("lists_multiple_fields.expected"));
}
...
fn test_tail() {
    ...
    assert_eq!(result.stdout,
               get_file_contents("lists_tail.expected"));
}

#[test]
fn test_change_delimiter() {
    let mut cmd = Command::new(PROGNAME);
    let result = run(&mut cmd.args(&["-d",
                                     ":",
                                     "--complement",
                                     "--output-delimiter=#",
                                     "-f",
                                     ...
                                     INPUT]));
    assert_eq!(result.stdout,
               get_file_contents("lists_change_delimiter.expected"));
}
