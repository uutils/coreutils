...
fn sort_ascii_only(bencher: Bencher, num_lines: usize) {
    ...
    bencher
        ...
        .bench_refs(|args| black_box(uumain(args)));
}
...
fn sort_case_insensitive(bencher: Bencher, num_lines: usize) {
    ...
    bencher
        .with_inputs(|| get_bench_args(&[&"-f", &"-o", &output_path, &file_path]).into_iter())
        .bench_refs(|args| black_box(uumain(args)));
}
...
fn sort_dictionary_order(bencher: Bencher, num_lines: usize) {
    ...
    bencher
        .with_inputs(|| get_bench_args(&[&"-d", &"-o", &output_path, &file_path]).into_iter())
        .bench_refs(|args| black_box(uumain(args)));
}
...
fn sort_numeric(bencher: Bencher, num_lines: usize) {
    ...
    bencher
        .with_inputs(|| get_bench_args(&[&"-n", &"-o", &output_path, &file_path]).into_iter())
        .bench_refs(|args| black_box(uumain(args)));
}
...
fn sort_general_numeric(bencher: Bencher, num_lines: usize) {
    ...
    bencher
        .with_inputs(|| get_bench_args(&[&"-g", &"-o", &output_path, &file_path]).into_iter())
        .bench_refs(|args| black_box(uumain(args)));
}
...
fn sort_reverse_locale(bencher: Bencher, num_lines: usize) {
    ...
    bencher
        .with_inputs(|| get_bench_args(&[&"-r", &"-o", &output_path, &file_path]).into_iter())
        .bench_refs(|args| black_box(uumain(args)));
}
...
fn sort_key_field(bencher: Bencher, num_lines: usize) {
    ...
    bencher
        ...
        .with_inputs(|| get_bench_args(&[&"-k", &"2", &"-o", &output_path, &file_path]).into_iter())
        .bench_refs(|args| black_box(uumain(args)));
}
...
fn sort_unique_locale(bencher: Bencher, num_lines: usize) {
    ...
    bencher
        .with_inputs(|| get_bench_args(&[&"-u", &"-o", &output_path, &file_path]).into_iter())
        .bench_refs(|args| black_box(uumain(args)));
}
...
fn sort_long_line(bencher: Bencher, line_size: usize) {
    ...
    bencher
        .with_inputs(|| get_bench_args(&[&file_a, &file_b, &"-o", &output_path]).into_iter())
        .bench_refs(|args| black_box(uumain(args)));
}
