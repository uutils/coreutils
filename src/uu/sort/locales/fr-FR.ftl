...
sort-parallel-must-be-nonzero = le nombre de tâches en parallèle ne doit pas être zéro
sort-invalid-parallel-arg = argument --parallel invalide '{$arg}'
sort-parallel-arg-too-large = argument --parallel '{$arg}' trop grand
