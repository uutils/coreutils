...
// spell-checker:ignore Uncategorized WSAEBADF stdlib untailable tailable
...
///
/// Can be used testing purposes, to store the error message instead of printing to `stderr`.
