...
pub fn uumain(args: impl uucore::Args) -> UResult<()> {
    ...
    let options = Options {
        ...
        kernel_name: matches.get_flag(crate::options::KERNEL_NAME),
        nodename: matches.get_flag(crate::options::NODENAME),
        kernel_release: matches.get_flag(crate::options::KERNEL_RELEASE),
        kernel_version: matches.get_flag(crate::options::KERNEL_VERSION),
        machine: matches.get_flag(crate::options::MACHINE),
        processor: matches.get_flag(crate::options::PROCESSOR),
        hardware_platform: matches.get_flag(crate::options::HARDWARE_PLATFORM),
        os: matches.get_flag(crate::options::OS),
    };
