...
pr-help-date-format = Utiliser le FORMAT de style 'date' pour la date dans la ligne d'en-tête.
...
pr-help-column =
    Produire une sortie multi-colonnes qui est arrangée en <colonne> colonnes
