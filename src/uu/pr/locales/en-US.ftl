...
pr-error-invalid-pages-argument = invalid --pages argument { $arg }
pr-error-invalid-pages-range = invalid page range { $range }
pr-error-invalid-plus-argument = invalid + argument { $arg }
pr-error-value-too-large = { $desc }: { $arg }: Value too large for defined data type
pr-error-numerical-result-out-of-range = { $desc }: { $arg }: Numerical result out of range
