shred-about =
    Écrase les FICHIER(s) spécifiés de manière répétée, afin de rendre plus difficile
    même pour du matériel de sondage très coûteux de récupérer les données.
shred-usage = shred [OPTION]... FICHIER...
shred-after-help =
    Supprime le ou les FICHIER(s) si --remove (-u) est spécifié. Par défaut, les fichiers
...
shred-exact-help =
    ne pas arrondir les tailles de fichier au bloc complet suivant ;
