...
impl Config {
    ...
    fn from_with_program_mode(
        ...
        // --dired turns hyperlinks off, and a later --hyperlink turns them back
        // on and cancels dired instead. Dired output also requires the final
        // format to be long: a later -C, -x, -m or --format= cancels it.
