...
numfmt-error-ambiguous-argument = ambiguous argument '{$arg}' for '{$opt}'
numfmt-diag-help-round = --round takes up, down, from-zero, towards-zero or nearest
numfmt-diag-help-invalid = --invalid takes abort, fail, warn or ignore
