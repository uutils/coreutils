    ...
    match input_strings.len() {
        ...
        2 => {
            ...
            match (offset0, offset1) {
                ...
                _ => Err(translate!("od-error-invalid-offset")),
            }
        }
        3 => {
            ...
            match (offset, label) {
                ...
                (Err(_), _) => Err(translate!("od-error-invalid-offset")),
                (_, Err(_)) => Err(translate!("od-error-invalid-label")),
            }
        }
        _ => Err(translate!("od-error-too-many-inputs")),
    }
}
