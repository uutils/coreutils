...
fn init_localization(
    ...
    let loc = if locale == &en_locale {
        ...
        match create_bundle(locale, locales_dir) {
            Ok(primary_bundle) => {
...
fn create_bundle(
    ...
    let locale_path = locales_dir.join(format!("{}.ftl", locale));
...
"#;
    ...
    fn test_get_message_with_args_pluralization() {
        std::thread::spawn(|| {
            ...
            assert_eq!(message1, "You have \u{2068}\u{2068}1\u{2069} items\u{2069}");
    ...
    fn test_detect_system_locale_from_lang_env() {
        ...
        let result = detect_system_locale();
        assert!(result.is_ok());
        assert_eq!(result.unwrap().to_string(), "es-ES");
    ...
    fn test_arabic_localization() {
        std::thread::spawn(|| {
            ...
            assert_eq!(message_zero, "لديك \u{2068}\u{2068}0\u{2069} عنصر\u{2069}");
            ...
            assert_eq!(message_one, "لديك \u{2068}\u{2068}1\u{2069} عنصر\u{2069}");
            ...
            assert_eq!(message_two, "لديك \u{2068}\u{2068}2\u{2069} عنصر\u{2069}");
            ...
            assert_eq!(message_few, "لديك \u{2068}\u{2068}5\u{2069} عنصر\u{2069}");
