...
pub struct ChecksumComputeOptions {
    ...
    /// The digest object.
    /// TODO: Maybe remove this ? It has nothing to do in "options".
    pub digest: Box<dyn Digest + 'static>,
...
pub fn perform_checksum_computation<'a, I>(
    mut options: ChecksumComputeOptions,
    files: I,
) -> UResult<()>
where
